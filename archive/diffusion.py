...
def main(rho_array, time_array, conc_in, conc_out, config):
    ...
    hit_probs = rec.hitting_prob(time_array, r_tx, D_space, dist, k_d)
    ...
    avg_hits_inst = rec.average_hits(time_array, S_released_instant, r_tx, D_space, dist, k_d)
    avg_hits_inst = avg_hits_inst[:step_count]
